        ...
        <form method="POST" action="{{route('pages-users-update')}}">
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              <input type="text" name="email" value="{{ $user->email}}" id="basic-default-email" class="form-control" placeholder="john.doe@example.com" aria-label="john.doe@example.com" aria-describedby="basic-default-email2" />
              <span class="input-group-text" id="basic-default-email2"></span>
            </div>
            <div class="form-text"> Puedes usar Números y letras  </div>
          </div>
          <div class="mb-3">
            <label class="form-label" for="basic-default-phone">Nueva Contraseña </label>
            <input type="password" name="new_password" id="basic-default-password" class="form-control" placeholder="***********" />
          </div>
